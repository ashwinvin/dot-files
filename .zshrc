...
export PATH=$HOME/bin:/usr/local/bin:$HOME/.local/bin:$CARGO:$NIMBLE:$GO:$GOPATH:$PY:$PYPY3:$POETRY:$RUBY:$PATH
...
alias Dmusic='youtube-dl --extract-audio --audio-format mp3 -o "%(title)s.%(ext)s" '
